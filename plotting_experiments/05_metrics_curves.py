...
Single-panel figure showing ERICA metrics (CRI, WCRI, TWCRI) vs K as
lines+markers, with vertical K* lines and 'x' markers for disqualified
K values.

Generated for each combination of dataset x clustering method.
"""
...
def plot_metrics_curves(er, dataset_name, method):
    """Create a single-panel metrics curves figure for a dataset/method combination.
    ...
    # Build arrays for each ERICA metric
